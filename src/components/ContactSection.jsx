                ...
                {[
                  {
                    icon: Linkedin,
                    label: "LinkedIn",
                    url: "https://www.linkedin.com/in/bakkia-sri-13776a24a/  ",
                  },

                  {
                    icon: Github,
                    label: "GitHub",
                    url: "https://github.com/bakkiasri/",
                  },
                ].map((social, index) => (
                  <a
                    key={index}
